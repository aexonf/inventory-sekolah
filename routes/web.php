...
Route::prefix("/admin")->group(function () {
    ...
    Route::controller(StudentController::class)->prefix("/student")->group(function() {
        ...
        Route::put("/{id}", "updateStudent")->name("admin.student.update");
        Route::delete("/{id}", "deleteStudent")->name("admin.student.delete");
    });
    ...
    Route::controller(ActiveStudentsController::class)->prefix("/student/active-student")->group(function() {
        ...
        Route::post("/", "createActiveStudent")->name("admin.active-student.create");
        Route::put("/{id}", "updateActiveStudent")->name("admin.active-student.update");
        Route::delete("/{id}", "deleteActiveStudent")->name("admin.active-student.delete");
    });
