        ...
        <div className="relative w-full">
            ...
            <div className="pt-[70px] px-[20px]" >
                <div className="py-[20px] px-[20px] shadow-[5px_5px_30px_-5px_#00000024]">
                    <h1 className="text-violet-600 font-semibold" >Informasi Sekolah</h1>
                    
                    <div className="flex flex-col mt-[50px] gap-5" >
                         <label className="flex justify-between" htmlFor="years">
                            <span className="w-[40%] text-[13px]">Tahun Pelajaran<span className="text-red-500">*</span></span>

                            <input className="rounded-sm border-gray-300 py-[5px] border-[1px] border-solid flex-grow" type="text" />
                        </label>
                        ...
                        <div className="w-full flex justify-end text-white mt-[30px]" >
                            <button className="bg-violet-600 text-[13px] py-[7px] px-[13px] rounded-md font-semibold">Submit</button>
                        </div>
                    </div>
               </div>
            </div>
